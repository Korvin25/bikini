...
lang : {
	...
	fullExpandTitle : 'Истиный размер (f)',
	creditsText : 'Powered by <i>Highslide JS</i>',
	creditsTitle : 'Go to the Highslide JS homepage',
	previousText : 'Открыть',
	nextText : 'Следующая', 
	moveText : 'Двигать',
	closeText : 'Закрыть', 
	...
	previousTitle : 'Предыдущая (<-- left)',
	nextTitle : 'Следующая (right -->)',
	moveTitle : 'Двигать',
	fullExpandText : '1:1',
	number: 'Изображение %1 из %2',
	restoreTitle : 'Нажмите, чтобы закрыть изображение. Нажмите и держите, чтобы переместить изображение. Используйте кнопки "влево" и "вправо", чтобы листать картинки.'
},
