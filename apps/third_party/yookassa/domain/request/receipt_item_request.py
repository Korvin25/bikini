...
class ReceiptItemRequest(BaseObject):
    ...
    def description(self, value):
        self.__description = unicode(value)
    ...
    def payment_mode(self, value):
        self.__payment_mode = unicode(value)
    ...
    def payment_subject(self, value):
        self.__payment_subject = unicode(value)
    ...
    def product_code(self, value):
        self.__product_code = unicode(value)
    ...
    def country_of_origin_code(self, value):
        self.__country_of_origin_code = unicode(value)
    ...
    def customs_declaration_number(self, value):
        self.__customs_declaration_number = unicode(value)
    ...
    def agent_type(self, value):
        self.__agent_type = unicode(value)
