...
from apps.third_party.yookassa.domain.models.airline import Airline
...
from apps.third_party.yookassa.domain.models.payment_data.payment_data import PaymentData
from apps.third_party.yookassa.domain.models.payment_data.payment_data_factory import PaymentDataFactory
from apps.third_party.yookassa.domain.models.receipt import Receipt
...
class PaymentRequest(RequestObject):
    ...
    def client_ip(self, value):
        self.__client_ip = unicode(value)
