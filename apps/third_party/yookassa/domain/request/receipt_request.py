# -*- coding: utf-8 -*-
from apps.third_party.yookassa.domain.common.receipt_type import ReceiptType
from apps.third_party.yookassa.domain.common.request_object import RequestObject
from apps.third_party.yookassa.domain.models.receipt_customer import ReceiptCustomer
from apps.third_party.yookassa.domain.models.settlement import Settlement
from apps.third_party.yookassa.domain.request.receipt_item_request import ReceiptItemRequest
...
class ReceiptRequest(RequestObject):
    ...
    def email(self, value):
        ...
        self.__customer.email = unicode(value)
    ...
    def phone(self, value):
        if self.__customer is None:
            self.__customer = ReceiptCustomer()
        self.__customer.phone = unicode(value)
