...
from apps.third_party.yookassa.domain.models import Settlement
from apps.third_party.yookassa.domain.response import ReceiptItemResponse
...
class ReceiptResponse(ResponseObject):
    ...
    def payment_id(self, value):
        self.__payment_id = unicode(value)
    ...
    def refund_id(self, value):
        self.__refund_id = unicode(value)
    ...
    def fiscal_document_number(self, value):
        self.__fiscal_document_number = unicode(value)
    ...
    def fiscal_storage_number(self, value):
        self.__fiscal_storage_number = unicode(value)
    ...
    def fiscal_attribute(self, value):
        self.__fiscal_attribute = unicode(value)
    ...
    def fiscal_provider_id(self, value):
        self.__fiscal_provider_id = unicode(value)
    ...
    def on_behalf_of(self, value):
        self.__on_behalf_of = unicode(value)
