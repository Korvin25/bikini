...
from apps.third_party.yookassa.domain.models.payment_data.payment_data import ResponsePaymentData
from apps.third_party.yookassa.domain.models.payment_data.request.payment_data_b2b_sberbank import VatData
...
class PaymentDataB2bSberbank(ResponsePaymentData):
    ...
    def payment_purpose(self, value):
        self.__payment_purpose = unicode(value)
...
class PayerBankDetails(BaseObject):
    ...
    def full_name(self, value):
        self.__full_name = unicode(value)
    ...
    def short_name(self, value):
        self.__short_name = unicode(value)
    ...
    def bank_name(self, value):
        self.__bank_name = unicode(value)
    ...
    def bank_branch(self, value):
        self.__bank_branch = unicode(value)
