...
import apps.third_party.yookassa
...
class UserAgent:
    ...
    def define_python():
        ...
        version = unicode(info.major) + '.' + str(info.minor) + '.' + str(info.micro)
        return Version('Python', version)

    @staticmethod
    def define_sdk():
        version = apps.third_party.yookassa.__version__
    ...
    def framework(self, value):
        self.__framework = unicode(value)
