    ...
    def update_product(self, product):
        ...
        for size in sizes:
            for color in colors:
                ...
                param_dict['attributes'].append(self.get_attributes(8229, product.categories.first().title_yandex)) # тип TODO доработать в будущев в завсисимомсти от категории
