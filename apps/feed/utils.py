...
class GenerateFeed:
    ...
    def get_offer_retailcrm(self, letters, name, vendorCode, url, price, categoryId, text, picture, photos, famile, count):
        ...
        self.sub_element(el_item, 'productName', name)
    ...
    def create_retailcrm_item(self, item, combinations, combinations_count):
        ...
        count = math.ceil(int(count) / combinations_count)
        count = str(count)
