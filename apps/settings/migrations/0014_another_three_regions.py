...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('settings', '0013_catalog_special_banner'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='seosetting',
            name='meta_desc_sch',
            field=models.TextField(blank=True, max_length=255, null=True, verbose_name='Meta description (\u0421\u043e\u0447\u0438)'),
        ),
        migrations.AddField(
            model_name='seosetting',
            name='meta_desc_smf',
            field=models.TextField(blank=True, max_length=255, null=True, verbose_name='Meta description (\u0421\u0438\u043c\u0444\u0435\u0440\u043e\u043f\u043e\u043b\u044c)'),
        ),
        migrations.AddField(
            model_name='seosetting',
            name='meta_desc_svs',
            field=models.TextField(blank=True, max_length=255, null=True, verbose_name='Meta description (\u0421\u0435\u0432\u0430\u0441\u0442\u043e\u043f\u043e\u043b\u044c)'),
        ),
        migrations.AddField(
            model_name='seosetting',
            name='meta_keyw_sch',
            field=models.TextField(blank=True, max_length=255, null=True, verbose_name='Meta keywords (\u0421\u043e\u0447\u0438)'),
        ),
        migrations.AddField(
            model_name='seosetting',
            name='meta_keyw_smf',
            field=models.TextField(blank=True, max_length=255, null=True, verbose_name='Meta keywords (\u0421\u0438\u043c\u0444\u0435\u0440\u043e\u043f\u043e\u043b\u044c)'),
        ),
        migrations.AddField(
            model_name='seosetting',
            name='meta_keyw_svs',
            field=models.TextField(blank=True, max_length=255, null=True, verbose_name='Meta keywords (\u0421\u0435\u0432\u0430\u0441\u0442\u043e\u043f\u043e\u043b\u044c)'),
        ),
        migrations.AddField(
            model_name='seosetting',
            name='seo_text_sch',
