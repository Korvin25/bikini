...
from filer.admin.folderadmin import *


__all__ = ['CustomFolderAdmin', 'CustomFileAdmin', 'CustomImageAdmin', ]
...
class CustomFolderAdmin(FolderAdmin):
    ...
    def directory_listing(self, request, folder_id=None, viewtype=None):
        ...
        if viewtype == 'unfiled_images':
            order_by = '-uploaded_at,original_filename'
        ###
...
class CustomFileAdmin(FileAdmin):
    list_display = ('label', 'folder', 'uploaded_at', 'modified_at',)
    list_per_page = 50
