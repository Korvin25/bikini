...
LOGGING = {
    ...
    'loggers': {
        ...
        'paypal': {
            'handlers': ['paypal_log_file', 'console'],
            'level': 'INFO',
        },
        'currency.tasks': {
...
THUMBNAIL_ALIASES = {
    '': {
        ...
        'product_cover': {'size': (300, 400), 'crop': True, 'quality': 100},
        ...
        'blog_cover_list': {'size': (10000, 10000), 'crop': False, 'quality': 100, 'upscale': False},
        'blog_cover_detail': {'size': (10000, 10000), 'crop': False, 'quality': 100, 'upscale': False},
